...
/**
 * Композитный фильтр, объединяющий несколько фильтров
 * с заданной логической операцией (AND или OR).
 *
 * <p>Позволяет строить сложные условия фильтрации динамически,
 * комбинируя простые фильтры в цепочки.
 */
