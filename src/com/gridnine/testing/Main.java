...
/**
 * Главный класс приложения для демонстрации работы системы фильтрации.
 *
 * <p>Выполняет три демонстрационных сценария:
 * <ol>
 *   <li>Динамическое создание фильтров через фабрику</li>
 *   <li>Композиция фильтров (AND, OR, NOT)</li>
 *   <li>Конфигурируемые правила через FilterConfiguration</li>
 * </ol>
 *
 * <p>Использует тестовый набор данных {@link FlightBuilder#createFlights()}
 * и выводит результаты в консоль с форматированием.
 */
public class Main {
